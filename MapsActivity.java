...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shop = (String) mapintent.getSerializableExtra("SHOP");
        Toast.makeText(MapsActivity.this, shop, Toast.LENGTH_LONG).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        addrtxt = getAddress(latitude, longitude);
        addrtxt += shop;

        Location place = addrToPoint(context);
        final LatLng nearplace = new LatLng(place.getLatitude(), place.getLongitude());
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(nearplace);
        ...
        mMap.setOnMapLoadedCallback(new GoogleMap.OnMapLoadedCallback(){
            ...
            public void onMapLoaded(){
                mMap.moveCamera(CameraUpdateFactory.newLatLng(nearplace));
    ...
    public Location addrToPoint(Context context){
        ...
        try{
            addresses = geocoder.getFromLocationName(addrtxt,10);
            Toast.makeText(MapsActivity.this, addrtxt, Toast.LENGTH_LONG).show();
        } catch (IOException e) {
            e.printStackTrace();
        }
        if(addresses!=null){
